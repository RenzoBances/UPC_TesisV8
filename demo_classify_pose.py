            ...
            if ret == True:
                ...
                try:
                    ...
                    if str(body_language_class) == '0':
                        body_language_class = 'bird_dog' 
                    elif str(body_language_class) == '1':
                        body_language_class = 'curl_up'
                    elif str(body_language_class) == '2':
                        body_language_class = 'front_plank'
                    elif str(body_language_class) == '3':
                        body_language_class = 'forward_lunge'
                    else:
                        body_language_class = 'push_up'
                    # Grab ear coords
